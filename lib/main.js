...
$(document).ready(function() {
  ...
  var clothing = {
    shirts: $('#progress-shirt-svg'),
    pants: $('#progress-pants-svg'),
    shoes: $('#progress-shoes-svg'),
    suitcases: $('#progress-suitcases-svg'),
    suits: $('#progress-suits-svg'),
    ties: $('#progress-ties-svg'),
    blouses: $('#progress-blouse-svg'),
    skirts: $('#progress-skirt-svg'),
    wShoes: $('#progress-wShoes-svg')
  };
    ...
    if (!section.hasClass('isActive')) {
      switch (index) {
        ...
        case 1:
          ...
          $.each(clothing, function(key, cloth) {
            cloth.css('opacity', 1);
          });
          ...
          var progressBlouse = new Vivus('progress-blouse-svg', {type: 'oneByOne'});
          var progressSkirt = new Vivus('progress-skirt-svg', {type:'oneByOne'});
          var progressWShoes = new Vivus('progress-wShoes-svg', {type: 'oneByOne'});
